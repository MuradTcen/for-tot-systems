...
export class ImportSecurities extends Component {
    ...
    onFileUpload = event => {
        ...
        axios.post("http://localhost:8080/api/security/import/", formData)
            .then(response => {
            ...
            <div class="container">
                <Form onSubmit={this.onFileUpload}>
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="inputGroupFile">Choose securities_*.xml</label>
